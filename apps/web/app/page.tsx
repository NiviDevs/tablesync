...
export default function Home() {
  return <main className="site-shell">
    <nav className="site-nav"><div className="brand">table<i>sync</i></div><div className="nav-actions"><Link href="/restaurant/sign-in">For restaurants</Link><Link className="text-link" href="/app?table=SAGE-12">Open demo table</Link></div></nav>
    <section className="landing-hero">
      <div className="hero-copy"><p className="kicker">Group dining, without the bill chaos</p><h1>The table is shared.<br /><em>The choice is yours.</em></h1><p className="hero-lede">Scan a table QR, add what you want, and pay only for your share. Your restaurant receives one calm, complete order.</p><div className="hero-actions"><Link className="primary-button" href="/app?table=SAGE-12">Try the live table <span>→</span></Link><Link className="secondary-button" href="/restaurant/sign-in">Restaurant sign in</Link></div><p className="quiet-note">Hosted demo · simulated payments only</p></div>
